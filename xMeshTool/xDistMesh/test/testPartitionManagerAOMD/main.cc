...
class entity: public AOMD::mEntity{
public: 
  entity( ):n{'a'}{}
  entity(  char _n):n{_n}{}
  char n;
  int getLevel() const override {return -1;}
  AOMD::mEntity::mType getType() const override { return AOMD::mEntity::mType::VERTEX; }
};
...
//xPartitionManager member function tested
//  directly:
//    constructor
//    destructor
//    getConstPartitionObject
//    getPartitionObject
//    copy constructor
//    remove
//    clear
//    beginObject,endObject
//xPartitionObject xContPartitionObject member function tested 
//    getOwner
//    getRange
//    insert( rank, address)
//    remove( rank)
...
//    getComm
//    getRemoteObjectOn
// xinterface::aomd::xAttachedDataManagerAOMD is tested also throught the calls on the partition manager :
//   tested :
...
int main(int argc, char *argv[]){
  ...
  if(!rank)
  {
      ...
      std::cout<<"post fix ++ oper test "<<(it_test==(cp_it_test++)); std::cout<<(static_cast<entity *>(*cp_it_test))->n<<std::endl;
  }
